...
const menuController = {
  createMenu: async (req, res) => {
    try {
      ...
      const menu = await db.Menu.create({ food_name, price })
  ...
  updateMenu: async (req, res) => {
    try {
      ...
      await db.Image.update({ image_url: image_url }, { where: { MenuId: id } })
  ...
  deleteMenu: async (req, res) => {
    try {
      ...
      await db.Menu.delete({ where: { id: id } })
      await db.Image.delete({ where: { MenuId: id } })
